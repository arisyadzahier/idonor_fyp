      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            icon: Image.asset('assets/images/logo_iDonor.png',
                fit: BoxFit.contain),
            onPressed: () => HomePage(),
          ),
        ],
...
//Statistics Box
              Container(
                ...
                decoration: BoxDecoration(
                  border: Border.all(
                      color: Color.fromARGB(255, 130, 224, 170), width: 3),
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.push(context,
                            MaterialPageRoute(builder: (_) => MUser()));
                      },
                      child: Text(
                        'USER',
                        style: TextStyle(color: Colors.white, fontSize: 16),
                  ...
                  Container(
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.push(context,
                            MaterialPageRoute(builder: (_) => MCard()));
                      },
                      child: Text(
                        'MANAGE \ne-CARD',
                        style: TextStyle(color: Colors.white, fontSize: 16),
